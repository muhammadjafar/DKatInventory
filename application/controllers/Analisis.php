		...
		foreach ($tbl_trs1->result() as $row){
		  ...
		  # __________________________________3 ITEM SET__________________________________ #
			    ...
			    for($i_at1 = 0; $i_at1<$i; $i_at1++){ # at1 = 0 -> end
					...
					for($i_at2 = $i_at1; $i_at2<$i; $i_at2++){ # at2 = current -> end
						...
						for($i_at3 = $i_at2; $i_at3<$i; $i_at3++){ # at3 = current -> end
							$at3 = $mn[$i_at3];
							if($mn[$i_at1]!=$mn[$i_at2] and $mn[$i_at1]!=$mn[$i_at3] and $mn[$i_at2]!=$mn[$i_at3]){
								for($i_cq = 0; $i_cq<$i; $i_cq++){ # cq = all except at1 and at2 and at3
									if($mn[$i_cq]!=$mn[$i_at1] and $mn[$i_cq]!=$mn[$i_at2] and $mn[$i_cq]!=$mn[$i_at3]){
										$cq = $mn[$i_cq];
										$key = $at1+','+$at2+','+$at3+'-'+$cq;
										$frekuen4 = 0;
			...
			if($i>4){
				for($i_at1=0; $i_at1<$i; $i_at1++){ # at1 = 0 -> end
					$at1 = $mn[$i_at1];
					for($i_at2=$i_at1; $i_at2<$i; $i++){ # at2 = current -> end
						$at2 = $mn[$i_at2];
						for($i_at3=$i_at2; $i_at3<$i; $i_at3++){ # at3 = current -> end
							$at3 = $mn[$i_at3];
							for($i_at4=$i_at3; $i_at4<$i; $i_at4++){ # at4 = current -> end
								$at4 = $mn[$i_at4];
								if($mn[$i_at1]!=$mn[$i_at2] and $mn[$i_at1]!=$mn[$i_at3] and $mn[$i_at1]!=$mn[$i_at4] and $mn[$i_at2]!=$mn[$i_at3] and $mn[$i_at2]!=$mn[$i_at4] and $mn[$i_at3]!=$mn[$i_at4]){
									for($i_cq=0; $i_cq<$i; $i_cq++){ # cq = all except at1 and at2 and at3
										if($mn[$i_cq]!=$mn[$i_at1] and $mn[$i_cq]!=$mn[$i_at2] and $mn[$i_cq]!=$mn[$i_at3] and $mn[$i_cq]!=$mn[$i_at4]){
											$cq = $mn[$i_cq];
